      ...
      <div className="p-4 space-y-4">
        ...
        <div className="bg-background-card border border-border rounded-card p-4 text-white">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="text-xs font-semibold uppercase tracking-wider text-secondary">{t('sidebar.widget.proPlan')}</span>
          </div>
          <p className="text-sm text-gray-300 mb-3">{t('sidebar.widget.scansRemaining', { count: 15 })}</p>
